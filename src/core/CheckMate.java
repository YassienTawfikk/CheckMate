...
public class CheckMate {
    ...
    public boolean isKingChecked(Move move) {
        ...
        // If there is a selected piece, and it is a King then update the King's row and
        // column with its new position
        if (board.selectedPiece != null && board.selectedPiece.name.equals("King")) {
            kingColumn = move.newColumn;
            kingRow = move.newRow;
        }

        // Check if the King is in check position from King, Queen, Rooks, Bishops,
        // Knights, Pawns.
     ...
     *
     * @param column          The valid column moves of every piece at the same team
     *                        with attacked King
     * @param row             The valid row moves of every piece at the same team
     *                        with attacked King
     ...
     * @return true if the queen can hit the king in the given direction, false
     *         otherwise
     **/
    private boolean checkByQueen(int column, int row, Piece King, int kingColumn, int kingRow, int columnDirection,
        ...
        for (int unit = 1; unit < 8; unit++) {
            ...
            if (piece != null && piece != board.selectedPiece) {
                ...
                // If the piece is Queen, and it's not the same team with the attacked King, so
                // it's checkmate
     ...
     * @param columnDirection The value of column direction the King is moving in
     *                        (-1, 0 or 1)
     * @param rowDirection    The value of row direction the King is moving in (-1,
     *                        0 or 1)
    ...
    private boolean checkByRook(int column, int row, Piece King, int kingColumn, int kingRow, int columnDirection,
        ...
        for (int unit = 1; unit < 8; unit++) {
            ...
            if (piece != null && piece != board.selectedPiece) {
                ...
                // If the piece is Rook, and it's not the same team with the attacked King, so
                // it's checkmate
     ...
     * @param king   the attacked king
     * @param column the valid column moves of every piece at the same team with
     *               King
    ...
    private boolean CheckByKnight(Piece piece, Piece king, int column, int row) {
        ...
        // Return true if the piece is Knight and not the same team with attacked King,
        // and can't be eaten by any piece,otherwise return false.
     ...
     * @param column     The valid column moves of every piece at the same team with
     *                   attacked King
     * @param row        The valid row moves of every piece at the same team with
     *                   attacked King
     * @param kingColumn The column where the king is located.
     * @param kingRow    The row where the king is located.
    ...
    private boolean hitByKnight(int column, int row, Piece King, int kingColumn, int kingRow) {
        return CheckByKnight(board.getPiece(kingColumn - 3, kingRow - 2), King, column, row) ||
    ...
    private boolean checkByPawn(int column, int row, Piece piece, Piece king) {
        ...
        // Return true if the piece is Pawn and not the same team with attacked King,
        // and can't be eaten by any piece,otherwise return false.
    ...
    private boolean hitByPawn(int column, int row, Piece king, int kingColumn, int kingRow) {
        ...
        return checkByPawn(column, row, board.getPiece(kingColumn + 1, kingRow + moveDirection), king) || // Front Right
                                                                                                          // Diagonal
                checkByPawn(column, row, board.getPiece(kingColumn - 1, kingRow + moveDirection), king) || // Front Left
                                                                                                           // Diagonal
