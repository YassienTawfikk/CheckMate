...
public class Board extends JPanel {
    ...
    public void pawnPromote(Move move) {
        // Display a menu to the player asking them which piece they want to promote the
        // pawn to.
        String[] options = { "Queen", "Rook", "Bishop", "Knight" };
        int choice = JOptionPane.showOptionDialog(null, "Choose a piece to promote the pawn to", "Pawn Promotion",
                JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        // Create a new piece of that type and place it on the square where the pawn was
        // located.
        switch (choice) {
            case 0:
    ...
    public void paintComponent(Graphics g) {
                    ...
                    if (isValidMove(new Move(this, selectedPiece, c, r))) {
                        ...
                        if (validTurn()) {
                            ...
                            if (getPiece(c, r) == null) {
                                ...
                                g2d.fillRoundRect(c * tileSize + 25, r * tileSize + 25, vmCircleRadius, vmCircleRadius,
                                        vmCircleRadius, vmCircleRadius);

                                // Set the stroke color to black and draw the round rectangle with a border
                                g2d.setStroke(new BasicStroke(1));
                                g2d.setColor(Color.BLACK);
                                g2d.drawRoundRect(c * tileSize + 25, r * tileSize + 25, vmCircleRadius, vmCircleRadius,
                                        vmCircleRadius, vmCircleRadius);
                            }
        ...
        if (selectedPiece != null
                && checkMate.isKingChecked(new Move(this, selectedPiece, selectedPiece.column, selectedPiece.row))) {
