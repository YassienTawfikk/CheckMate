...
public class Piece {
    ...
    /**
     * Constructor for creating a new Piece object and initializing the Board
     * object.
     *
    ...
    // public Piece(int x, int y, Player player, String string, Block block) {
    ...
    /**
     * Checks if a Piece object will hit another Piece object when moved to a given
     * location.
     *
     * @param column The column to which the Piece is to be moved.
     * @param row    The row to which the Piece is to be moved.
