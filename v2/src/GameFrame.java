...
public class GameFrame extends JFrame {
    ...
    public GameFrame() {
        ...
        // Initialize the player info panels
        p1info = new JPanel();
        p2info = new JPanel();

        // Add player names to the info panels
        ...
        // Add player info panels to the info card
        infoCard.add(p1info);
        infoCard.add(p2info);

        // Initialize eaten pieces panels
        p1Eaten = new JPanel();
        p2Eaten = new JPanel();
        ...
        p1EatenR1 = new JPanel();
        p2EatenR2 = new JPanel();
        p1EatenR3 = new JPanel();
        p2EatenR4 = new JPanel();
        p1EatenR1 = new JPanel();
        p2EatenR1 = new JPanel();
        p1EatenR2 = new JPanel();
        p2EatenR3 = new JPanel();
        p1EatenR4 = new JPanel();
        ...
        p1Eaten.add(p1EatenR1);
        p1Eaten.add(p1EatenR2);
        p1Eaten.add(p1EatenR3);
        p1Eaten.add(p1EatenR4);

        p2Eaten.add(p2EatenR1);
        p2Eaten.add(p2EatenR2);
        p2Eaten.add(p2EatenR3);
        p2Eaten.add(p2EatenR4);

        infoCard.add(p1Eaten);
        infoCard.add(p2Eaten);
    ...
    public void drawEatenPiece(String eatenPiece, boolean isWhite) {
        ...
        for (int i = 0; i < (!isWhite ? GameFrame.p1EatenPieces.length : GameFrame.p2EatenPieces.length); i++)
            if ((!isWhite ? GameFrame.p1EatenPieces[i] : GameFrame.p2EatenPieces[i]) != null)
                count++;
